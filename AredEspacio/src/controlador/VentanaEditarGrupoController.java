...
public class VentanaEditarGrupoController implements Initializable {
    ...
    public void establecerGrupo(String nombreGrupo){
        ...
        grupo=grupoDAO.adquirirGrupo(nombreGrupo);
        listaUsuarios=grupoDAO.adquirirCuentas();
        campoNombre.setText(nombreGrupo);
                    ...
                    if(columna!=0){
                        ...
                        switch(columna){
                            case 1:
                                ...
                                }else if((nuevoHorario.getDomingo().equals("Ocupado"))||(nuevoHorario.getDomingo().equals(grupo.getNombreGrupo()))){
                            ...
                            case 2:
                                ...
                                }else if((nuevoHorario.getLunes().equals("Ocupado"))||(nuevoHorario.getLunes().equals(grupo.getNombreGrupo()))){
                            ...
                            case 3:
                                ...
                                }else if((nuevoHorario.getMartes().equals("Ocupado"))||(nuevoHorario.getMartes().equals(grupo.getNombreGrupo()))){
                            ...
                            case 4:
                                ...
                                }else if((nuevoHorario.getMiercoles().equals("Ocupado"))||(nuevoHorario.getMiercoles().equals(grupo.getNombreGrupo()))){
                            ...
                            case 5:
                                ...
                                }else if((nuevoHorario.getJueves().equals("Ocupado"))||(nuevoHorario.getJueves().equals(grupo.getNombreGrupo()))){
                            ...
                            case 6:
                                ...
                                }else if((nuevoHorario.getViernes().equals("Ocupado"))||(nuevoHorario.getViernes().equals(grupo.getNombreGrupo()))){
                            ...
                            case 7:
                                ...
                                }else if((nuevoHorario.getSabado().equals("Ocupado"))||(nuevoHorario.getSabado().equals(grupo.getNombreGrupo()))){
                ...
                switch(temp){
                    case 0:
                        if(horarioActualizar.getDomingo().equals("Ocupado")){
                            eElement.getElementsByTagName(nombreFila).item(0).setTextContent(campoNombre.getText());
                        }else{
